...
## 快速开始
### 基本步骤
1. 安装依赖：yt-dlp和ffmpeg
2. 下载release中的可执行文件，放入空文件夹
3. 在文件夹内创建config.toml文件，复制config目录下的config-example.toml文件的内容，并对照填写你的配置信息。
4. 双击可执行文件，启动服务
5. 打开浏览器，输入http://127.0.0.1:8888，开始使用 (8888替换成你在配置文件中填写的端口)
